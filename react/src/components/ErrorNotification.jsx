const ErrorNotification = ({message,clearNotification}) => {
    return ( 
            <div class="relative">
            
            <div id="alert-2" class="flex z-10 mt-[10%]  items-center p-4 mb-4 text-red-800 rounded-lg  bg-red-50 dark:bg-gray-800 dark:text-red-400 border-none" role="alert">
